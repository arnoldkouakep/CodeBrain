...
public class MenuBackOffice extends JButton {
    ...
    public MenuBackOffice(JPanel mainPanel, JToolBar menu) {
        this.menu = menu;
        this.mainPanel = mainPanel;
        this.menuIndex = menu.getComponents().length;

        setText(Dictionnaire.get(EnumLibelles.Business_Libelle_BackOffice.toString(), true));
    ...
    public void addComponentPanel() {
        ...
        this.menuButton.setText(Dictionnaire.get(EnumLibelles.Business_Libelle_BackOffice));
