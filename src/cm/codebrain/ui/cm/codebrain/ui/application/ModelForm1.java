 ...
 * @author KSA-INET
 */
public class ModelForm1 extends javax.swing.JDialog {
...
//    private Loading loading;
     ...
     * @param title
     */
    public ModelForm1(String title) {
        super();
...
//        Locale.initBundle();
    ...
    public ModelForm1(String title, int width, int height) {
...
//        Locale.initBundle();
    ...
    public void addFormData(String key, Object value) {
        this.formDatas.putIfAbsent(value, value);
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setFont(new java.awt.Font("sansserif", 2, 8)); // NOI18N
        jLabel2.setText("© CodeBrain@2018");
        jLabel2.setVerticalAlignment(javax.swing.SwingConstants.BOTTOM);
        jLabel2.setEnabled(false);
        bottonPanel.add(jLabel2, java.awt.BorderLayout.WEST);
...
//        JSheet.showMessageSheet(SwingUtilities.windowForComponent(btnCreate), "Bonjour", JOptionPane.INFORMATION_MESSAGE);
    ...
    public void actionBtnValider(java.awt.event.ActionEvent evt) {
        switch (this.etatAction) {
            case 1:
                JSheet.showMessageSheet(SwingUtilities.windowForComponent(btnValider), "Create", JOptionPane.INFORMATION_MESSAGE);
                break;
            case 2:
                JSheet.showMessageSheet(SwingUtilities.windowForComponent(btnValider), "Modifiy", JOptionPane.INFORMATION_MESSAGE);
                break;
            case 3:
                JSheet.showMessageSheet(SwingUtilities.windowForComponent(btnValider), "Dupplicate", JOptionPane.INFORMATION_MESSAGE);
                break;
            default:
                JSheet.showMessageSheet(SwingUtilities.windowForComponent(btnValider), "Delete", JOptionPane.INFORMATION_MESSAGE);
                break;
        }
    ...
    public void setAction(int etatAction) {
    ...
    public void setActionRef(Object fieldActionRef) {
        this.fieldActionRef = fieldActionRef;
    }
