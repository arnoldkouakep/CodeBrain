...
public class MenuClasse extends JButton {
    ...
    public MenuClasse(JPanel mainPanel, JToolBar menu) {
        ...
        setText(Dictionnaire.get(EnumLibelles.Business_Libelle_Classe));
    ...
    public void addComponentPanel(JPanel mainPanel, JToolBar menu){
        ...
        this.menuButton.setText(Dictionnaire.get(EnumLibelles.Business_Libelle_Classe));
...
//        mainPanel.add(new MenuClasse(mainPanel, menu));
    ...
    private void goToHere(JPanel mainPanel){
        ...
        new MenuClasse(mainPanel, menu).addComponentPanel(mainPanel, menu);
    }
}
