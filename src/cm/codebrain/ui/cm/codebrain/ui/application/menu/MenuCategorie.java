...
import cm.codebrain.ui.application.backoffice.CategorieForm;
...
public class MenuCategorie extends JButton {
    ...
    public MenuCategorie(JPanel mainPanel, JToolBar menu) {
        ...
        setText(Dictionnaire.get(EnumLibelles.Business_Libelle_Categorie));
    ...
    public void addComponentPanel(JPanel mainPanel, JToolBar menu) {
        form = new CategorieForm(Dictionnaire.get(EnumLibelles.Business_Libelle_Categorie));
