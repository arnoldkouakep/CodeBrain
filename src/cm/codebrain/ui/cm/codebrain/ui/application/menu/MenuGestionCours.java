...
public class MenuGestionCours extends JButton {
    ...
    public MenuGestionCours(JPanel mainPanel, JToolBar menu) {
        this.menu = menu;
        this.mainPanel = mainPanel;
        this.menuIndex = menu.getComponents().length;

        setText(Dictionnaire.get(EnumLibelles.Business_Libelle_GestionCours.toString(), true));
    ...
    public void addComponentPanel() {
        ...
        this.menuButton.setText(Dictionnaire.get(EnumLibelles.Business_Libelle_GestionCours));
        ...
        addPanel(this.mainPanel,
                new MenuCours(this.mainPanel, this.menu),
                new MenuEnseignant(this.mainPanel, this.menu)
        );
    }
