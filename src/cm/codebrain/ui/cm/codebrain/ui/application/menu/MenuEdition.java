...
public class MenuEdition extends JButton {
    ...
    public MenuEdition(JPanel mainPanel, JToolBar menu) {
        this.menu = menu;
        this.mainPanel = mainPanel;
        this.menuIndex = menu.getComponents().length;
        
        setText(Dictionnaire.get(EnumLibelles.Business_Libelle_Edition.toString(), true));
    ...
    public void addComponentPanel() {
        ...
        this.menuButton.setText(Dictionnaire.get(EnumLibelles.Business_Libelle_Edition));
         ...
         * Panel Home
         */
//                new MenuEdition(this.mainPanel, this.menu)
//        );
    }
