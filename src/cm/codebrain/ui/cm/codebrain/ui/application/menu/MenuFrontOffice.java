...
public class MenuFrontOffice extends JButton {
    ...
    public MenuFrontOffice(JPanel mainPanel, JToolBar menu) {
        this.menu = menu;
        this.mainPanel = mainPanel;
        this.menuIndex = menu.getComponents().length;
        
        setText(Dictionnaire.get(EnumLibelles.Business_Libelle_FrontOffice.toString(), true));
    ...
    public void addComponentPanel() {
        ...
        this.menuButton.setText(Dictionnaire.get(EnumLibelles.Business_Libelle_FrontOffice));
